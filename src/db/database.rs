...
use mysql_async::{params, prelude::Queryable, Error, Value};

use crate::models::incoming::{
    AddOrUpdateUniqueIdentifierRequest, GetProductLocationsByCode, GetProductLocationsByName,
    UniqueIdentifier,
};
...
impl Database {
    ...
    pub async fn add_or_update_unique_identifier(
        ...
        let query_product =
            "select product_code FROM products WHERE color = :color AND product_name = :product_name";
    ...
    pub async fn remove_unique_identifier(
        ...
        // Update pcs field
        let update_query =
            "UPDATE unique_identifiers SET pcs = pcs - ? WHERE concatenated_string = ?";
...
mod tests {
    ...
    async fn add_or_update_unique_identifier() {
        ...
        let param = AddOrUpdateUniqueIdentifierRequest {
            color: "Peach".to_string(),
            product_name: "Smart thermostat".to_string(),
            warehouse: "test_warehouse".to_string(),
            location: "Nice".to_string(),
            pcs: 123,
        };

        let result = db.add_or_update_unique_identifier(&param).await;
    ...
    async fn remove_unique_identifier() {
        ...
        // Add an identifier to ensure it exists before removal
        let param = AddOrUpdateUniqueIdentifierRequest {
            color: "Peach".to_string(),
            product_name: "Smart thermostat".to_string(),
            warehouse: "test_warehouse".to_string(),
        ...
        db.add_or_update_unique_identifier(&param).await.unwrap();

        let remove_param = RemoveUniqueIdentifierRequest {
            color: "Peach".to_string(),
            product_name: "Smart thermostat".to_string(),
            location: "Nice".to_string(),
            warehouse: "test_warehouse".to_string(),
        ...
        let result = db.remove_unique_identifier(&remove_param).await;
